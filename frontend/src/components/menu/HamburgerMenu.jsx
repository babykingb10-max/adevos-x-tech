...
export default function HamburgerMenu({ open, onClose }) {
  ...
  return (
    <>
      ...
      {/* Rendered as a sibling of <header> in Navbar.jsx (not nested inside it) —
          header uses backdrop-blur, which creates a new containing block for
          position:fixed descendants and would otherwise clip this panel to the
          header's own small height. Keep it a sibling if you ever move this. */}
      <div
